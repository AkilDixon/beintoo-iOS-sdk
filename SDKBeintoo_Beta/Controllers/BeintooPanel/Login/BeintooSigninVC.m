...
- (void)viewDidLoad
{
    ...
    NSString *htmlString1 = [NSString stringWithFormat:@"<html><head> <style> body {margin: 0; padding: 0px; font-family: 'Helvetica', sans-serif; background-color: transparent; line-height:17px; font-weight:bold; font-size:14px;} </style></head><body><div><span style=\"color:#2E4467; text-shadow: 0px 1px 0px #FFF;\">%@</span> <span style=\"color:#586985; text-shadow: 0px 1px 0px #FFF;\">%@</span> <span style=\" color:#2E4467; text-shadow: 0px 1px 0px #FFF;\">%@</span> <span style=\" color:#586985; text-shadow: 0px 1px 0px #FFF;\">%@</span>   <span style=\"color:#2E4467; text-shadow: 0px 1px 0px #FFF;\">%@</span>  <span style=\" color:#586985; text-shadow: 0px 1px 0px #FFF;\">%@</span> </div> </body></html>", NSLocalizedStringFromTable(@"signupMainSentence1", @"BeintooLocalizable", nil), NSLocalizedStringFromTable(@"signupMainSentence2", @"BeintooLocalizable", nil), NSLocalizedStringFromTable(@"signupMainSentence3", @"BeintooLocalizable", nil), NSLocalizedStringFromTable(@"signupMainSentence4", @"BeintooLocalizable", nil), NSLocalizedStringFromTable(@"signupMainSentence5", @"BeintooLocalizable", nil), NSLocalizedStringFromTable(@"signupMainSentence6", @"BeintooLocalizable", nil)];
