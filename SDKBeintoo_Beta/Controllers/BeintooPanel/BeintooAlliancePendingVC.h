...
@interface BeintooAlliancePendingVC : UIViewController <UIActionSheetDelegate, UITableViewDelegate,UITableViewDataSource,BeintooAllianceDelegate,BImageDownloadDelegate> {
