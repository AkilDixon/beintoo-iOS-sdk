...
- (id)initWithCoder:(NSCoder *)coder
{
    ...
    if (self)
    {
        ...
        isBanner        = ([coder decodeObjectForKey:@"isBanner"]) ? [NSNumber numberWithBool:[[[coder decodeObjectForKey:@"isBanner"] copy] boolValue]] : nil;
    }
    return self;
}
...
{
    BRewardWrapper *object = [[BRewardWrapper alloc] init];
